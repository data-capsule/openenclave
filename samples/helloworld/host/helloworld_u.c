...
enum
{
    ...
    helloworld_fcn_id_enclave_helloworld2 = 1,
    helloworld_fcn_id_oe_get_sgx_report_ecall = 2,
    helloworld_fcn_id_oe_get_report_v2_ecall = 3,
    helloworld_fcn_id_oe_verify_local_report_ecall = 4,
    helloworld_fcn_id_oe_sgx_init_context_switchless_ecall = 5,
    helloworld_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 6,
...
typedef struct _enclave_helloworld2_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} enclave_helloworld2_args_t;
...
oe_result_t helloworld_enclave_helloworld2(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    enclave_helloworld2_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_helloworld2_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_helloworld2_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_helloworld2_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_enclave_helloworld2].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_helloworld2_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(helloworld_enclave_helloworld2, enclave_helloworld2);
...
enum
{
    ...
    helloworld_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 78,
    helloworld_fcn_id_oe_verify_quote_ocall = 79,
    helloworld_fcn_id_oe_sgx_get_cpuid_table_ocall = 80,
    helloworld_fcn_id_oe_sgx_backtrace_symbols_ocall = 81,
    helloworld_fcn_id_oe_sgx_log_backtrace_ocall = 82,
