...
static void ecall_enclave_helloworld2(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_helloworld2_args_t* _pargs_in = (enclave_helloworld2_args_t*)input_buffer;
    enclave_helloworld2_args_t* _pargs_out = (enclave_helloworld2_args_t*)output_buffer;
...
oe_ecall_func_t oe_ecalls_table[] = {
    ...
    (oe_ecall_func_t) ecall_enclave_helloworld2,
